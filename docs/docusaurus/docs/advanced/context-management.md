...
description: Manage context windows, token usage, and the /compact command
sidebar_position: 2
keywords: [copilot, cli, context, tokens, compact, optimization]
---
...
→ Continue to [Module 12: Advanced Topics](/docs/advanced/advanced-topics)
