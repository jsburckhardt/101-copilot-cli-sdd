---
title: "Hooks"
description: "Lifecycle hooks and automation for Copilot CLI workflows"
sidebar_position: 1
keywords: [copilot, cli, hooks, lifecycle, automation]
---
...
Continue to [Context Management](/docs/advanced/context-management)
