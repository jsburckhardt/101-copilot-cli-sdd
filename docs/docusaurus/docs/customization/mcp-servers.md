---
title: "MCP Servers"
description: "Configure remote and local MCP servers for extended capabilities"
sidebar_position: 3
keywords: [copilot, cli, mcp, servers, tools, integration]
---
...
→ Continue to [Module 7: Agent Skills](/docs/extensibility/agent-skills)
