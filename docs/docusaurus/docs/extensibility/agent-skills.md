---
title: Agent Skills
description: Create and use skills from agentskills.io
sidebar_position: 1
keywords: [copilot, cli, skills, agents, extensibility, agentskills]
---
...
* Discover skills from [agentskills.io](https://agentskills.io)
...
* Can be shared publicly via [agentskills.io](https://agentskills.io)
...
1. Visit [agentskills.io](https://agentskills.io)
...
<details>
<summary>Exercise 5: Skill with Scripts (Bonus)</summary>
...
<details>
<summary>Exercise 6: Skill Invocation (Bonus)</summary>
...
<details>
<summary>Skill Structure Reference</summary>
...
* ✅ [agentskills.io](https://agentskills.io) provides community-created skills
...
→ Continue to [Module 8: Plugins](/docs/extensibility/plugins)
