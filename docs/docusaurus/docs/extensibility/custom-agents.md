---
title: "Custom Agents"
description: "Build specialized agents and subagents for focused workflows"
sidebar_position: 3
keywords: [copilot, cli, agents, custom, subagents, workflows]
---
...
<details>
<summary>Exercise 5: Organization-Level Agents (Bonus)</summary>
...
<details>
<summary>Exercise 6: Subagents and Delegation (Bonus)</summary>
...
<details>
<summary>Exercise 7: Debugging Agent Configuration (Bonus)</summary>
...
:::note[v0.0.415 Changes]
Unknown frontmatter fields now produce a warning instead of blocking agent load, making agents more forward-compatible.

Agents are model-aware. When asked which model is powering them, they can respond accurately.
:::
...
→ Continue to [Module 10: Hooks](/docs/advanced/hooks)
