---
title: Plugins
description: Plugins and the marketplace ecosystem for extending Copilot CLI
sidebar_position: 2
keywords: [copilot, cli, plugins, marketplace, extensions]
---
...
Continue to [Module 9: Custom Agents](/docs/extensibility/custom-agents)
