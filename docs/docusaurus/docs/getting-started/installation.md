...
sidebar_position: 1
keywords: [copilot, cli, installation, setup, npm, homebrew]
---
...
1. Create a fine-grained PAT at [github.com/settings/personal-access-tokens](https://github.com/settings/personal-access-tokens/new)
...
→ Continue to [Module 2: Operating Modes](/docs/getting-started/modes-and-commands)
