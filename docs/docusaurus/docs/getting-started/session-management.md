...
description: "Continue, resume, clear, and track Copilot CLI sessions"
sidebar_position: 4
keywords: [copilot, cli, sessions, resume, context, management]
---
...
→ Continue to [Module 4: Custom Instructions](/docs/customization/custom-instructions)
