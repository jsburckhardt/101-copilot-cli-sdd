...
export function GettingStartedIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
      <defs>
        <linearGradient id="gettingStartedGrad" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#e8740c" />
          <stop offset="100%" stopColor="#c4314b" />
        </linearGradient>
      </defs>
      <path d="M32 4c-6 6-12 14-12 26h24C44 18 38 10 32 4z" fill="url(#gettingStartedGrad)" />
      <path d="M32 4c-6 6-12 14-12 26h12V4z" fill="url(#gettingStartedGrad)" opacity="0.85" />
...
export function CustomizationIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
...
export function ExtensibilityIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
...
export function AdvancedIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
      <defs>
      ...
      <path d="M32 4C20 4 12 14 12 24c0 7 3 11 7 15v5h26v-5c4-4 7-8 7-15C52 14 44 4 32 4z" fill="url(#advancedGrad)" />
      <path d="M32 4C20 4 12 14 12 24c0 7 3 11 7 15v5h13V4z" fill="url(#advancedGrad)" opacity="0.85" />
